...
intégration **Voice Chat**, **Playit.gg** et un **agent IA** (Gemini ou Ollama).
...
- Provider au choix :
  - **Gemini API** : collez votre clé (Google AI Studio) + modèle
    (`gemini-2.5-flash` par défaut).
  - **Ollama local** : `http://localhost:11434`, liste des modèles auto-détectée.
